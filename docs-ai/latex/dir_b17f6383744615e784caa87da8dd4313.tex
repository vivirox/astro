\doxysection{node\+\_\+modules/ts-\/node/node\+\_\+modules/diff Directory Reference}
\hypertarget{dir_b17f6383744615e784caa87da8dd4313}{}\label{dir_b17f6383744615e784caa87da8dd4313}\index{node\_modules/ts-\/node/node\_modules/diff Directory Reference@{node\_modules/ts-\/node/node\_modules/diff Directory Reference}}
...
Based on the algorithm proposed in \href{http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.4.6927}{\texttt{ "{}\+An O(\+ND) Difference Algorithm and its Variations"{} (Myers, 1986)}}.\hypertarget{README.md_autotoc_md33612}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md33612}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ diff\ -\/-\/save}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md33613}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md33613}
...
Returns a list of change objects (See below).
\item {\ttfamily Js\+Diff.\+diff\+Css(old\+Str, new\+Str\mbox{[}, options\mbox{]})} -\/ diffs two blocks of text, comparing CSS tokens.

Returns a list of change objects (See below).
\item {\ttfamily Js\+Diff.\+diff\+Json(old\+Obj, new\+Obj\mbox{[}, options\mbox{]})} -\/ diffs two JSON objects, comparing the fields defined on each. The order of fields, etc does not matter in this comparison.
...
Return a JSON object representation of the a patch, suitable for use with the {\ttfamily apply\+Patch} method. This parses to the same structure returned by {\ttfamily Js\+Diff.\+structured\+Patch}.
\item {\ttfamily convert\+Changes\+To\+XML(changes)} -\/ converts a list of changes to a serialized XML format
\end{DoxyItemize}

All methods above which accept the optional {\ttfamily callback} method will run in sync mode when that parameter is omitted and in async mode when supplied. This allows for larger diffs without blocking the event loop. This may be passed either directly as the final parameter or as the {\ttfamily callback} field in the {\ttfamily options} object.\hypertarget{README.md_autotoc_md33614}{}\doxysubsubsection{\texorpdfstring{Change Objects}{Change Objects}}\label{README.md_autotoc_md33614}
...
Note that some cases may omit a particular flag field. Comparison on the flag fields should always be done in a truthy or falsy manner.\hypertarget{README.md_autotoc_md33615}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{README.md_autotoc_md33615}
Basic example in Node


\begin{DoxyCode}{0}
\DoxyCodeLine{require('colors');}
\DoxyCodeLine{var\ jsdiff\ =\ require('diff');}
\DoxyCodeLine{}
\DoxyCodeLine{var\ one\ =\ 'beep\ boop';}
\DoxyCodeLine{var\ other\ =\ 'beep\ boob\ blah';}
\DoxyCodeLine{}
\DoxyCodeLine{var\ diff\ =\ jsdiff.diffChars(one,\ other);}
\DoxyCodeLine{}
\DoxyCodeLine{diff.forEach(function(part)\{}
\DoxyCodeLine{\ \ //\ green\ for\ additions,\ red\ for\ deletions}
\DoxyCodeLine{\ \ //\ grey\ for\ common\ parts}
\DoxyCodeLine{\ \ var\ color\ =\ part.added\ ?\ 'green'\ :}
\DoxyCodeLine{\ \ \ \ part.removed\ ?\ 'red'\ :\ 'grey';}
\DoxyCodeLine{\ \ process.stderr.write(part.value[color]);}
\DoxyCodeLine{\});}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ //\ green\ for\ additions,\ red\ for\ deletions}
\DoxyCodeLine{\ \ //\ grey\ for\ common\ parts}
\DoxyCodeLine{\ \ color\ =\ part.added\ ?\ 'green'\ :}
\DoxyCodeLine{\ \ \ \ part.removed\ ?\ 'red'\ :\ 'grey';}
...
{\bfseries{\href{http://kpdecker.github.com/jsdiff}{\texttt{ Full online demo}}}}\hypertarget{README.md_autotoc_md33616}{}\doxysubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{README.md_autotoc_md33616}
\href{https://saucelabs.com/u/jsdiff}{\texttt{ }}

jsdiff supports all ES3 environments with some known issues on IE8 and below. Under these browsers some diff algorithms such as word diff and others may fail due to lack of support for capturing groups in the {\ttfamily split} operation.\hypertarget{README.md_autotoc_md33617}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md33617}
See \href{https://github.com/kpdecker/jsdiff/blob/master/LICENSE}{\texttt{ LICENSE}}. 