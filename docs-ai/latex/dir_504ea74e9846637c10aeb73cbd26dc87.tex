\doxysection{node\+\_\+modules/@isaacs/fs-\/minipass Directory Reference}
\hypertarget{dir_504ea74e9846637c10aeb73cbd26dc87}{}\label{dir_504ea74e9846637c10aeb73cbd26dc87}\index{node\_modules/"@isaacs/fs-\/minipass Directory Reference@{node\_modules/"@isaacs/fs-\/minipass Directory Reference}}
...
The async versions work much like their node builtin counterparts, with the exception of introducing significantly less Stream machinery overhead.\hypertarget{README.md_autotoc_md3887}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md3887}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md3888}{}\doxysubsection{\texorpdfstring{Read\+Stream(path, options)}{Read\+Stream(path, options)}}\label{README.md_autotoc_md3888}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md3889}{}\doxysubsection{\texorpdfstring{Write\+Stream(path, options)}{Write\+Stream(path, options)}}\label{README.md_autotoc_md3889}
Path string is required, but somewhat irrelevant if an open file descriptor is passed in as an option.
