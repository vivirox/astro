\doxysection{node\+\_\+modules/nopt Directory Reference}
\hypertarget{dir_8d010611d39ea4cf5f890bd7c24a9cd2}{}\label{dir_8d010611d39ea4cf5f890bd7c24a9cd2}\index{node\_modules/nopt Directory Reference@{node\_modules/nopt Directory Reference}}
...
Read the tests at the bottom of {\ttfamily lib/nopt.\+js} for more examples of what this puppy can do.\hypertarget{README.md_autotoc_md24647}{}\doxysubsubsection{\texorpdfstring{Types}{Types}}\label{README.md_autotoc_md24647}
...
You can also call {\ttfamily nopt.\+clean(data, types, type\+Defs)} to clean up a config object and remove its invalid properties.\hypertarget{README.md_autotoc_md24648}{}\doxysubsubsection{\texorpdfstring{Error Handling}{Error Handling}}\label{README.md_autotoc_md24648}
By default nopt logs debug messages if {\ttfamily DEBUG\+\_\+\+NOPT} or {\ttfamily NOPT\+\_\+\+DEBUG} are set in the environment.

You can assign the following methods to {\ttfamily nopt} for a more granular notification of invalid, unknown, and expanding options\+:

{\ttfamily nopt.\+invalid\+Handler(key, value, type, data)} -\/ Called when a value is invalid for its option. {\ttfamily nopt.\+unknown\+Handler(key, next)} -\/ Called when an option is found that has no configuration. In certain situations the next option on the command line will be parsed on its own instead of as part of the unknown option. In this case {\ttfamily next} will contain that option. {\ttfamily nopt.\+abbrev\+Handler(short, long)} -\/ Called when an option is automatically translated via abbreviations.

You can also set any of these to {\ttfamily false} to disable the debugging messages that they generate.\hypertarget{README.md_autotoc_md24649}{}\doxysubsubsection{\texorpdfstring{Abbreviations}{Abbreviations}}\label{README.md_autotoc_md24649}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24650}{}\doxysubsubsection{\texorpdfstring{Shorthands}{Shorthands}}\label{README.md_autotoc_md24650}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24651}{}\doxysubsubsection{\texorpdfstring{The Rest of the args}{The Rest of the args}}\label{README.md_autotoc_md24651}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24652}{}\doxysubsubsection{\texorpdfstring{Slicing}{Slicing}}\label{README.md_autotoc_md24652}
