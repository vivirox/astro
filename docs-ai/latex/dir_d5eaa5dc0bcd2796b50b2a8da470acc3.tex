\doxysection{node\+\_\+modules/fs-\/minipass Directory Reference}
\hypertarget{dir_d5eaa5dc0bcd2796b50b2a8da470acc3}{}\label{dir_d5eaa5dc0bcd2796b50b2a8da470acc3}\index{node\_modules/fs-\/minipass Directory Reference@{node\_modules/fs-\/minipass Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_fb1415148891a2e52974292c9b718d16}{node\+\_\+modules}}
...
The async versions work much like their node builtin counterparts, with the exception of introducing significantly less Stream machinery overhead.\hypertarget{README.md_autotoc_md15935}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md15935}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md15936}{}\doxysubsection{\texorpdfstring{Read\+Stream(path, options)}{Read\+Stream(path, options)}}\label{README.md_autotoc_md15936}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md15937}{}\doxysubsection{\texorpdfstring{Write\+Stream(path, options)}{Write\+Stream(path, options)}}\label{README.md_autotoc_md15937}
Path string is required, but somewhat irrelevant if an open file descriptor is passed in as an option.
