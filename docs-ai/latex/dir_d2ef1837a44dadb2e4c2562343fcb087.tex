...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24162}{}\doxysubsection{\texorpdfstring{Usage in Type\+Script}{Usage in Type\+Script}}\label{README.md_autotoc_md24162}
...
Emitting/handling events that aren\textquotesingle{}t declared in this way is fine, but the arguments will be typed as {\ttfamily unknown}.\hypertarget{README.md_autotoc_md24163}{}\doxysubsection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{README.md_autotoc_md24163}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{README.md_autotoc_md24164}{}\doxysubsubsection{\texorpdfstring{Timing}{Timing}}\label{README.md_autotoc_md24164}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24165}{}\doxysubsubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{README.md_autotoc_md24165}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24166}{}\doxysubsubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{README.md_autotoc_md24166}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{README.md_autotoc_md24167}{}\doxysubsubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{README.md_autotoc_md24167}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{README.md_autotoc_md24168}{}\doxysubsubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{README.md_autotoc_md24168}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{README.md_autotoc_md24169}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{README.md_autotoc_md24169}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{README.md_autotoc_md24170}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{README.md_autotoc_md24170}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{README.md_autotoc_md24171}{}\doxysubsubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{README.md_autotoc_md24171}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{README.md_autotoc_md24172}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md24172}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24173}{}\doxysubsubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{README.md_autotoc_md24173}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24174}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md24174}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{README.md_autotoc_md24175}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{README.md_autotoc_md24175}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24176}{}\doxysubsubsection{\texorpdfstring{Properties}{Properties}}\label{README.md_autotoc_md24176}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24177}{}\doxysubsubsection{\texorpdfstring{Events}{Events}}\label{README.md_autotoc_md24177}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24178}{}\doxysubsubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{README.md_autotoc_md24178}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24179}{}\doxysubsection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{README.md_autotoc_md24179}
Here are some examples of things you can do with Minipass streams.\hypertarget{README.md_autotoc_md24180}{}\doxysubsubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{README.md_autotoc_md24180}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24181}{}\doxysubsubsection{\texorpdfstring{collecting}{collecting}}\label{README.md_autotoc_md24181}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24182}{}\doxysubsubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{README.md_autotoc_md24182}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24183}{}\doxysubsubsection{\texorpdfstring{iteration}{iteration}}\label{README.md_autotoc_md24183}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24184}{}\doxysubsubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{README.md_autotoc_md24184}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24185}{}\doxysubsubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{README.md_autotoc_md24185}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24186}{}\doxysubsubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{README.md_autotoc_md24186}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24187}{}\doxysubsubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{README.md_autotoc_md24187}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24188}{}\doxysubsubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{README.md_autotoc_md24188}
