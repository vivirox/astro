\doxysection{node\+\_\+modules/http-\/cache-\/semantics Directory Reference}
\hypertarget{dir_9f295402d73ca10a537d9526b2f7ee28}{}\label{dir_9f295402d73ca10a537d9526b2f7ee28}\index{node\_modules/http-\/cache-\/semantics Directory Reference@{node\_modules/http-\/cache-\/semantics Directory Reference}}


\doxysubsection{Detailed Description}
{\ttfamily Cache\+Policy} tells when responses can be reused from a cache, taking into account \href{http://httpwg.org/specs/rfc7234.html}{\texttt{ HTTP RFC 7234}} rules for user agents and shared caches. It also implements \href{https://tools.ietf.org/html/rfc5861}{\texttt{ RFC 5861}}, implementing {\ttfamily stale-\/if-\/error} and {\ttfamily stale-\/while-\/revalidate}. It\textquotesingle{}s aware of many tricky details such as the {\ttfamily Vary} header, proxy revalidation, and authenticated responses.\hypertarget{README.md_autotoc_md17905}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md17905}
...
The key method is {\ttfamily satisfies\+Without\+Revalidation(new\+Request)}, which checks whether the {\ttfamily new\+Request} is compatible with the original request and whether all caching conditions are met.\hypertarget{README.md_autotoc_md17906}{}\doxysubsubsection{\texorpdfstring{Constructor options}{Constructor options}}\label{README.md_autotoc_md17906}
...
If {\ttfamily options.\+ignore\+Cargo\+Cult} is true, common anti-\/cache directives will be completely ignored if the non-\/standard {\ttfamily pre-\/check} and {\ttfamily post-\/check} directives are present. These two useless directives are most commonly found in bad Stack\+Overflow answers and PHP\textquotesingle{}s "{}session limiter"{} defaults.\hypertarget{README.md_autotoc_md17907}{}\doxysubsubsection{\texorpdfstring{{\ttfamily storable()}}{{\ttfamily storable()}}}\label{README.md_autotoc_md17907}
Returns {\ttfamily true} if the response can be stored in a cache. If it\textquotesingle{}s {\ttfamily false} then you MUST NOT store either the request or the response.\hypertarget{README.md_autotoc_md17908}{}\doxysubsubsection{\texorpdfstring{{\ttfamily satisfies\+Without\+Revalidation(new\+Request)}}{{\ttfamily satisfies\+Without\+Revalidation(new\+Request)}}}\label{README.md_autotoc_md17908}
...
If it returns {\ttfamily false}, then the response may not be matching at all (e.\+g. it\textquotesingle{}s for a different URL or method), or may require to be refreshed first (see {\ttfamily revalidation\+Headers()}).\hypertarget{README.md_autotoc_md17909}{}\doxysubsubsection{\texorpdfstring{{\ttfamily response\+Headers()}}{{\ttfamily response\+Headers()}}}\label{README.md_autotoc_md17909}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md17910}{}\doxysubsubsection{\texorpdfstring{{\ttfamily time\+To\+Live()}}{{\ttfamily time\+To\+Live()}}}\label{README.md_autotoc_md17910}
Returns approximate time in {\itshape milliseconds} until the response becomes stale (i.\+e. not fresh).

After that time (when {\ttfamily time\+To\+Live() \texorpdfstring{$<$}{<}= 0}) the response might not be usable without revalidation. However, there are exceptions, e.\+g. a client can explicitly allow stale responses, so always check with {\ttfamily satisfies\+Without\+Revalidation()}. {\ttfamily stale-\/if-\/error} and {\ttfamily stale-\/while-\/revalidate} extend the time to live of the cache, that can still be used if stale.\hypertarget{README.md_autotoc_md17911}{}\doxysubsubsection{\texorpdfstring{{\ttfamily to\+Object()}/{\ttfamily from\+Object(json)}}{{\ttfamily to\+Object()}/{\ttfamily from\+Object(json)}}}\label{README.md_autotoc_md17911}
Chances are you\textquotesingle{}ll want to store the {\ttfamily Cache\+Policy} object along with the cached response. {\ttfamily obj = policy.\+to\+Object()} gives a plain JSON-\/serializable object. {\ttfamily policy = Cache\+Policy.\+from\+Object(obj)} creates an instance from it.\hypertarget{README.md_autotoc_md17912}{}\doxysubsubsection{\texorpdfstring{Refreshing stale cache (revalidation)}{Refreshing stale cache (revalidation)}}\label{README.md_autotoc_md17912}
When a cached response has expired, it can be made fresh again by making a request to the origin server. The server may respond with status 304 (Not Modified) without sending the response body again, saving bandwidth.

The following methods help perform the update efficiently and correctly.\hypertarget{README.md_autotoc_md17913}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily revalidation\+Headers(new\+Request)}}{{\ttfamily revalidation\+Headers(new\+Request)}}}\label{README.md_autotoc_md17913}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md17914}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily revalidated\+Policy(revalidation\+Request, revalidation\+Response)}}{{\ttfamily revalidated\+Policy(revalidation\+Request, revalidation\+Response)}}}\label{README.md_autotoc_md17914}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md17915}{}\doxysubsection{\texorpdfstring{Yo, FRESH}{Yo, FRESH}}\label{README.md_autotoc_md17915}
\hypertarget{README.md_autotoc_md17916}{}\doxysubsubsection{\texorpdfstring{Used by}{Used by}}\label{README.md_autotoc_md17916}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17917}{}\doxysubsubsection{\texorpdfstring{Implemented}{Implemented}}\label{README.md_autotoc_md17917}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17918}{}\doxysubsubsection{\texorpdfstring{Unimplemented}{Unimplemented}}\label{README.md_autotoc_md17918}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17919}{}\doxysubsubsubsection{\texorpdfstring{Trusting server {\ttfamily Date}}{Trusting server {\ttfamily Date}}}\label{README.md_autotoc_md17919}
