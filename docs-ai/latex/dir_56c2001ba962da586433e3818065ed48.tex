\doxysection{node\+\_\+modules/eslint-\/plugin-\/jsdoc/node\+\_\+modules/spdx-\/expression-\/parse Directory Reference}
\hypertarget{dir_56c2001ba962da586433e3818065ed48}{}\label{dir_56c2001ba962da586433e3818065ed48}\index{node\_modules/eslint-\/plugin-\/jsdoc/node\_modules/spdx-\/expression-\/parse Directory Reference@{node\_modules/eslint-\/plugin-\/jsdoc/node\_modules/spdx-\/expression-\/parse Directory Reference}}
...
\`{}\`{}`javascript var identifiers = \mbox{[}\mbox{]} .concat(require(\textquotesingle{}spdx-\/license-\/ids')) .concat(require(\textquotesingle{}spdx-\/license-\/ids/deprecated\textquotesingle{})) .filter(function (id) \{ return id\mbox{[}id.\+length -\/ 1\mbox{]} !== \textquotesingle{}+\textquotesingle{} \})
...
This package differs slightly from the SPDX standard in allowing lower-\/ and mixed-\/case {\ttfamily AND}, {\ttfamily OR}, and {\ttfamily WITH} operators\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{assert.deepEqual(}
\DoxyCodeLine{\ \ parse('MIT\ or\ BSD-\/2-\/Clause'),}
\DoxyCodeLine{\ \ \{\ left:\ \{\ license:\ 'MIT'\ \},\ conjunction:\ 'or',\ right:\ \{\ license:\ 'BSD-\/2-\/Clause'\ \}\ \}}
\DoxyCodeLine{)}
\DoxyCodeLine{assert.deepEqual(}
\DoxyCodeLine{\ \ parse('GPL-\/2.0\ with\ GCC-\/exception-\/2.0'),}
\DoxyCodeLine{\ \ \{\ license:\ 'GPL-\/2.0',\ exception:\ 'GCC-\/exception-\/2.0'\ \}}
\DoxyCodeLine{)}
