\doxysection{node\+\_\+modules/data-\/urls/node\+\_\+modules/whatwg-\/url Directory Reference}
\hypertarget{dir_bb78ff7e46e0c8240413a2317229f53d}{}\label{dir_bb78ff7e46e0c8240413a2317229f53d}\index{node\_modules/data-\/urls/node\_modules/whatwg-\/url Directory Reference@{node\_modules/data-\/urls/node\_modules/whatwg-\/url Directory Reference}}


\doxysubsection{Detailed Description}
whatwg-\/url is a full implementation of the WHATWG \href{https://url.spec.whatwg.org/}{\texttt{ URL Standard}}. It can be used standalone, but it also exposes a lot of the internal algorithms that are useful for integrating a URL parser into a project like \href{https://github.com/jsdom/jsdom}{\texttt{ jsdom}}.\hypertarget{README.md_autotoc_md11320}{}\doxysubsection{\texorpdfstring{Specification conformance}{Specification conformance}}\label{README.md_autotoc_md11320}
...
whatwg-\/url does not yet implement any encoding handling beyond UTF-\/8. That is, the {\itshape encoding override} parameter does not exist in our API.\hypertarget{README.md_autotoc_md11321}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md11321}
\hypertarget{README.md_autotoc_md11322}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily URL} and {\ttfamily URLSearch\+Params} classes}{The {\ttfamily URL} and {\ttfamily URLSearch\+Params} classes}}\label{README.md_autotoc_md11322}
The main API is provided by the \href{https://url.spec.whatwg.org/\#url-class}{\texttt{ {\ttfamily URL}}} and \href{https://url.spec.whatwg.org/\#interface-urlsearchparams}{\texttt{ {\ttfamily URLSearch\+Params}}} exports, which follows the spec\textquotesingle{}s behavior in all ways (including e.\+g. {\ttfamily USVString} conversion). Most consumers of this library will want to use these.\hypertarget{README.md_autotoc_md11323}{}\doxysubsubsection{\texorpdfstring{Low-\/level URL Standard API}{Low-\/level URL Standard API}}\label{README.md_autotoc_md11323}
...
Serve the contents of the {\ttfamily live-\/viewer} directory using any web server.\hypertarget{README.md_autotoc_md11326}{}\doxysubsection{\texorpdfstring{Supporting whatwg-\/url}{Supporting whatwg-\/url}}\label{README.md_autotoc_md11326}
