...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{README.md_autotoc_md14733}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md14733}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md14734}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md14734}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ etag\ =\ require('etag')}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md14735}{}\doxysubsubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, \mbox{[}options\mbox{]})}}\label{README.md_autotoc_md14735}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md14736}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md14736}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{README.md_autotoc_md14737}{}\doxysubsubsubsubsection{\texorpdfstring{weak}{weak}}\label{README.md_autotoc_md14737}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{README.md_autotoc_md14738}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md14738}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md14739}{}\doxysubsection{\texorpdfstring{Benchmark}{Benchmark}}\label{README.md_autotoc_md14739}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md14740}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md14740}
