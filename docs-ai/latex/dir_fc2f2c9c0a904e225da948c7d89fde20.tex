\doxysection{node\+\_\+modules/dom-\/helpers Directory Reference}
\hypertarget{dir_fc2f2c9c0a904e225da948c7d89fde20}{}\label{dir_fc2f2c9c0a904e225da948c7d89fde20}\index{node\_modules/dom-\/helpers Directory Reference@{node\_modules/dom-\/helpers Directory Reference}}


\doxysubsection{Detailed Description}
tiny modular DOM lib for ie9+\hypertarget{README.md_autotoc_md12030}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md12030}
...
\item {\ttfamily query\+Selector\+All(element, selector)}\+: optimized qsa, uses {\ttfamily get\+Element\+By\{Id\texorpdfstring{$\vert$}{|}\+Tag\+Name\texorpdfstring{$\vert$}{|}\+Class\+Name\}} if it can.
...
\item {\ttfamily offset(element)} -\/\texorpdfstring{$>$}{>} {\ttfamily \{ top\+: Number, left\+: Number, height\+: Number, width\+: Number\}}
\item {\ttfamily offset\+Parent(element)}\+: return the parent node that the element is offset from
\item {\ttfamily position(element, \mbox{[}offset\+Parent\mbox{]}}\+: return "{}offset"{} of the node to its offset\+Parent, optionally you can specify the offset parent if different than the "{}real"{} one
...
\item {\ttfamily get\+Computed\+Style(element)} -\/\texorpdfstring{$>$}{>} {\ttfamily get\+Property\+Value(name)}
