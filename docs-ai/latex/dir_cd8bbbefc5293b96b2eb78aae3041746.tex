\doxysection{node\+\_\+modules/@types/three/node\+\_\+modules/fflate Directory Reference}
\hypertarget{dir_cd8bbbefc5293b96b2eb78aae3041746}{}\label{dir_cd8bbbefc5293b96b2eb78aae3041746}\index{node\_modules/"@types/three/node\_modules/fflate Directory Reference@{node\_modules/"@types/three/node\_modules/fflate Directory Reference}}


\doxysubsection{Detailed Description}
High performance (de)compression in an 8kB package\hypertarget{README.md_autotoc_md6872}{}\doxysubsection{\texorpdfstring{Why fflate?}{Why fflate?}}\label{README.md_autotoc_md6872}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md6873}{}\doxysubsection{\texorpdfstring{Demo}{Demo}}\label{README.md_autotoc_md6873}
If you\textquotesingle{}d like to try {\ttfamily fflate} for yourself without installing it, you can take a look at the \href{https://101arrowz.github.io/fflate}{\texttt{ browser demo}}. Since {\ttfamily fflate} is a pure Java\+Script library, it works in both the browser and Node.\+js (see \href{https://github.com/101arrowz/fflate/\#browser-support}{\texttt{ Browser support}} for more info).\hypertarget{README.md_autotoc_md6874}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md6874}
...
\DoxyCodeLine{\ \ \ \ \ \ '你好.txt':\ std('Hey\ there!')}
\DoxyCodeLine{\ \ \ \ \},}
...
\DoxyCodeLine{\ \ 'myImageData.bmp':\ [aMassiveFile,\ \{}
\DoxyCodeLine{\ \ \ \ level:\ 9,}
\DoxyCodeLine{\ \ \ \ mem:\ 12,}
\DoxyCodeLine{\ \ \ \ //\ ZIP-\/specific:\ mtime\ works\ here\ too,\ defaults\ to\ current\ time}
...
\DoxyCodeLine{\ \ //\ Obfuscate\ mtime\ by\ default}
\DoxyCodeLine{\ \ mtime:\ 0}
\DoxyCodeLine{\});}
\DoxyCodeLine{}
...
\DoxyCodeLine{//\ myImageData.bmp}
\DoxyCodeLine{//\ superTinyFile.bin}
\DoxyCodeLine{}
...
\DoxyCodeLine{//\ \{\ 'nested/directory/a2.txt':\ Uint8Array(2)\ [97,\ 97]\ \})}
...
\DoxyCodeLine{//\ Also\ parallelized,\ so\ unzip\ is\ also\ often\ much\ faster\ than\ unzipSync}
...
\DoxyCodeLine{exampleFile.push(ec2a);}
\DoxyCodeLine{exampleFile.push(ec2b);}
\DoxyCodeLine{exampleFile.push(ec2c);}
\DoxyCodeLine{...}
\DoxyCodeLine{exampleFile.push(ec2Final,\ true);}
\DoxyCodeLine{zip.end();}
\DoxyCodeLine{}
...
See the \href{https://github.com/101arrowz/fflate/blob/master/docs/README.md}{\texttt{ documentation}} for more detailed information about the API.\hypertarget{README.md_autotoc_md6875}{}\doxysubsection{\texorpdfstring{Bundle size estimates}{Bundle size estimates}}\label{README.md_autotoc_md6875}
Since {\ttfamily fflate} uses ES Modules, this table should give you a general idea of {\ttfamily fflate}\textquotesingle{}s bundle size for the features you need. The maximum bundle size that is possible with {\ttfamily fflate} is about 27kB if you use every single feature, but feature parity with {\ttfamily pako} is only around 10kB (as opposed to 45kB from {\ttfamily pako}). If your bundle size increases dramatically after adding {\ttfamily fflate}, please \href{https://github.com/101arrowz/fflate/issues/new}{\texttt{ create an issue}}.
...
\end{longtabu}
\hypertarget{README.md_autotoc_md6876}{}\doxysubsection{\texorpdfstring{What makes {\ttfamily fflate} so fast?}{What makes {\ttfamily fflate} so fast?}}\label{README.md_autotoc_md6876}
...
Other than that, {\ttfamily fflate} is completely ES3, meaning you probably won\textquotesingle{}t even need a bundler to use it.\hypertarget{README.md_autotoc_md6878}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md6878}
...
Note that the time it takes for the CLI to show the completion of each test is not representative of the time each package took, so please check the JSON output if you want accurate measurements.\hypertarget{README.md_autotoc_md6879}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md6879}
