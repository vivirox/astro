\doxysection{node\+\_\+modules/@trunkio/launcher/node\+\_\+modules/minipass Directory Reference}
\hypertarget{dir_cb5af981bc385574cd4f60a604b6c002}{}\label{dir_cb5af981bc385574cd4f60a604b6c002}\index{node\_modules/"@trunkio/launcher/node\_modules/minipass Directory Reference@{node\_modules/"@trunkio/launcher/node\_modules/minipass Directory Reference}}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6433}{}\doxysubsection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{README.md_autotoc_md6433}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{README.md_autotoc_md6434}{}\doxysubsubsection{\texorpdfstring{Timing}{Timing}}\label{README.md_autotoc_md6434}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6435}{}\doxysubsubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{README.md_autotoc_md6435}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6436}{}\doxysubsubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{README.md_autotoc_md6436}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{README.md_autotoc_md6437}{}\doxysubsubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{README.md_autotoc_md6437}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{README.md_autotoc_md6438}{}\doxysubsubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{README.md_autotoc_md6438}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{README.md_autotoc_md6439}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{README.md_autotoc_md6439}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{README.md_autotoc_md6440}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{README.md_autotoc_md6440}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{README.md_autotoc_md6441}{}\doxysubsubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{README.md_autotoc_md6441}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{README.md_autotoc_md6442}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md6442}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6443}{}\doxysubsubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{README.md_autotoc_md6443}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6444}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md6444}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{README.md_autotoc_md6445}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{README.md_autotoc_md6445}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6446}{}\doxysubsubsection{\texorpdfstring{Properties}{Properties}}\label{README.md_autotoc_md6446}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6447}{}\doxysubsubsection{\texorpdfstring{Events}{Events}}\label{README.md_autotoc_md6447}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6448}{}\doxysubsubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{README.md_autotoc_md6448}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6449}{}\doxysubsection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{README.md_autotoc_md6449}
Here are some examples of things you can do with Minipass streams.\hypertarget{README.md_autotoc_md6450}{}\doxysubsubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{README.md_autotoc_md6450}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6451}{}\doxysubsubsection{\texorpdfstring{collecting}{collecting}}\label{README.md_autotoc_md6451}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6452}{}\doxysubsubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{README.md_autotoc_md6452}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6453}{}\doxysubsubsection{\texorpdfstring{iteration}{iteration}}\label{README.md_autotoc_md6453}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6454}{}\doxysubsubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{README.md_autotoc_md6454}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6455}{}\doxysubsubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{README.md_autotoc_md6455}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6456}{}\doxysubsubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{README.md_autotoc_md6456}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6457}{}\doxysubsubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{README.md_autotoc_md6457}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6458}{}\doxysubsubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{README.md_autotoc_md6458}
