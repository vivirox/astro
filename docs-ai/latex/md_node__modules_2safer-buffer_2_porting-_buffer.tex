...
\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30201}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30201}%


\label{md_node__modules_2safer-buffer_2_porting-_buffer_overview}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_overview}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30202}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30202}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2safer-buffer_2_porting-_buffer_variant-1}{Variant 1\+: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.} ({\itshape recommended})
\item \doxylink{md_node__modules_2safer-buffer_2_porting-_buffer_variant-2}{Variant 2\+: Use a polyfill}
\item \doxylink{md_node__modules_2safer-buffer_2_porting-_buffer_variant-3}{Variant 3\+: manual detection, with safeguards}
\end{DoxyItemize}\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30203}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30203}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30204}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.\+js 8}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30204}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30205}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30205}
...
\label{md_node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30206}{}\doxysection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30206}
...
{\itshape If you currently support those older Node.\+js versions and dropping them would be a semver-\/major change for you, or if you support older branches of your packages, consider using \doxylink{md_node__modules_2safer-buffer_2_porting-_buffer_variant-2}{Variant 2} or \doxylink{md_node__modules_2safer-buffer_2_porting-_buffer_variant-3}{Variant 3} on older branches, so people using those older branches will also receive the fix. That way, you will eradicate potential issues caused by unguarded Buffer API usage and your users will not observe a runtime deprecation warning when running your code on Node.\+js 10.}

\label{md_node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30207}{}\doxysection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2\+: Use a polyfill}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30207}
Utilize \href{https://www.npmjs.com/package/safer-buffer}{\texttt{ safer-\/buffer}} as a polyfill to support older Node.\+js versions.

You would take exacly the same steps as in \doxylink{md_node__modules_2safer-buffer_2_porting-_buffer_variant-1}{Variant 1}, but with a polyfill `const Buffer = require(\textquotesingle{}safer-\/buffer').Buffer{\ttfamily in all files where you use the new}Buffer\`{} api.
...
\label{md_node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30208}{}\doxysection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30208}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30209}{}\doxysubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30209}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30210}{}\doxysubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(not\+Number)}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30210}
Before\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30212}{}\doxysection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.\+alloc\+Unsafe}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30212}
...
\label{md_node__modules_2safer-buffer_2_porting-_buffer_faq}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_faq}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30213}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30213}
\label{md_node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30214}{}\doxysubsection{\texorpdfstring{What is wrong with the {\ttfamily Buffer} constructor?}{What is wrong with the {\ttfamily Buffer} constructor?}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30214}
...
\label{md_node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30215}{}\doxysubsection{\texorpdfstring{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md30215}
