\doxysection{node\+\_\+modules/jest-\/runner/node\+\_\+modules/source-\/map-\/support Directory Reference}
\hypertarget{dir_7a65902140ecae66c8e7fdf4fa4863df}{}\label{dir_7a65902140ecae66c8e7fdf4fa4863df}\index{node\_modules/jest-\/runner/node\_modules/source-\/map-\/support Directory Reference@{node\_modules/jest-\/runner/node\_modules/source-\/map-\/support Directory Reference}}


\doxysubsection{Detailed Description}
\href{https://travis-ci.org/evanw/node-source-map-support}{\texttt{ }}

This module provides source map support for stack traces in node via the \href{https://github.com/v8/v8/wiki/Stack-Trace-API}{\texttt{ V8 stack trace API}}. It uses the \href{https://github.com/mozilla/source-map}{\texttt{ source-\/map}} module to replace the paths and line numbers of source-\/mapped files with their original paths and line numbers. The output mimics node\textquotesingle{}s stack trace format with the goal of making every compile-\/to-\/\+JS language more of a first-\/class citizen. Source maps are completely general (not specific to any one language) so you can use source maps with multiple compile-\/to-\/\+JS languages in the same node process.\hypertarget{README.md_autotoc_md20213}{}\doxysubsection{\texorpdfstring{Installation and Usage}{Installation and Usage}}\label{README.md_autotoc_md20213}
\hypertarget{README.md_autotoc_md20214}{}\doxysubsubsubsection{\texorpdfstring{Node support}{Node support}}\label{README.md_autotoc_md20214}
...
From here you have two options.\hypertarget{README.md_autotoc_md20215}{}\doxysubsubsubsubsection{\texorpdfstring{CLI Usage}{CLI Usage}}\label{README.md_autotoc_md20215}

\begin{DoxyCode}{0}
\DoxyCodeLine{node\ -\/r\ source-\/map-\/support/register\ compiled.js}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md20216}{}\doxysubsubsubsubsection{\texorpdfstring{Programmatic Usage}{Programmatic Usage}}\label{README.md_autotoc_md20216}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20217}{}\doxysubsubsubsection{\texorpdfstring{Browser support}{Browser support}}\label{README.md_autotoc_md20217}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20218}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md20218}
...
This monkey patches the {\ttfamily require} module loading chain, so is not enabled by default and is not recommended for any sort of production usage.\hypertarget{README.md_autotoc_md20219}{}\doxysubsection{\texorpdfstring{Demos}{Demos}}\label{README.md_autotoc_md20219}
\hypertarget{README.md_autotoc_md20220}{}\doxysubsubsubsection{\texorpdfstring{Basic Demo}{Basic Demo}}\label{README.md_autotoc_md20220}
original.\+js\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20221}{}\doxysubsubsubsection{\texorpdfstring{Type\+Script Demo}{Type\+Script Demo}}\label{README.md_autotoc_md20221}
demo.\+ts\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20222}{}\doxysubsubsubsection{\texorpdfstring{Coffee\+Script Demo}{Coffee\+Script Demo}}\label{README.md_autotoc_md20222}
demo.\+coffee\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20223}{}\doxysubsection{\texorpdfstring{Tests}{Tests}}\label{README.md_autotoc_md20223}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20224}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md20224}
