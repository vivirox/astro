\doxysection{node\+\_\+modules/@atproto/api/node\+\_\+modules/zod Directory Reference}
\hypertarget{dir_e2dc93babe24571781e789aa5b992c58}{}\label{dir_e2dc93babe24571781e789aa5b992c58}\index{node\_modules/"@atproto/api/node\_modules/zod Directory Reference@{node\_modules/"@atproto/api/node\_modules/zod Directory Reference}}
...
~\newline
\hypertarget{README.md_autotoc_md1843}{}\doxysubsubsection{\texorpdfstring{Table of contents}{Table of contents}}\label{README.md_autotoc_md1843}
\begin{quote}
...
\end{DoxyItemize}
\item Changelog
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1844}{}\doxysubsubsection{\texorpdfstring{Introduction}{Introduction}}\label{README.md_autotoc_md1844}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1845}{}\doxysubsubsection{\texorpdfstring{Sponsors}{Sponsors}}\label{README.md_autotoc_md1845}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1848}{}\doxysubsubsubsubsection{\texorpdfstring{API libraries}{API libraries}}\label{README.md_autotoc_md1848}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1849}{}\doxysubsubsubsubsection{\texorpdfstring{Form integrations}{Form integrations}}\label{README.md_autotoc_md1849}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1850}{}\doxysubsubsubsubsection{\texorpdfstring{Zod to X}{Zod to X}}\label{README.md_autotoc_md1850}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1851}{}\doxysubsubsubsubsection{\texorpdfstring{X to Zod}{X to Zod}}\label{README.md_autotoc_md1851}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1852}{}\doxysubsubsubsubsection{\texorpdfstring{Mocking}{Mocking}}\label{README.md_autotoc_md1852}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1853}{}\doxysubsubsubsubsection{\texorpdfstring{Powered by Zod}{Powered by Zod}}\label{README.md_autotoc_md1853}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1854}{}\doxysubsubsubsubsection{\texorpdfstring{Utilities for Zod}{Utilities for Zod}}\label{README.md_autotoc_md1854}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1855}{}\doxysubsubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md1855}
\hypertarget{README.md_autotoc_md1856}{}\doxysubsubsubsection{\texorpdfstring{Requirements}{Requirements}}\label{README.md_autotoc_md1856}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1857}{}\doxysubsubsubsection{\texorpdfstring{From {\ttfamily npm}}{From {\ttfamily npm}}}\label{README.md_autotoc_md1857}
...
\hypertarget{README.md_autotoc_md1858}{}\doxysubsubsection{\texorpdfstring{Basic usage}{Basic usage}}\label{README.md_autotoc_md1858}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1859}{}\doxysubsubsection{\texorpdfstring{Primitives}{Primitives}}\label{README.md_autotoc_md1859}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1860}{}\doxysubsubsection{\texorpdfstring{Coercion for primitives}{Coercion for primitives}}\label{README.md_autotoc_md1860}
...
For more control over coercion logic, consider using \`{}z.preprocess\`{} or \`{}z.pipe()\`{}.\hypertarget{README.md_autotoc_md1861}{}\doxysubsubsection{\texorpdfstring{Literals}{Literals}}\label{README.md_autotoc_md1861}
...
\hypertarget{README.md_autotoc_md1862}{}\doxysubsubsection{\texorpdfstring{Strings}{Strings}}\label{README.md_autotoc_md1862}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1863}{}\doxysubsubsubsection{\texorpdfstring{Datetimes}{Datetimes}}\label{README.md_autotoc_md1863}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1864}{}\doxysubsubsubsection{\texorpdfstring{Dates}{Dates}}\label{README.md_autotoc_md1864}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1865}{}\doxysubsubsubsection{\texorpdfstring{Times}{Times}}\label{README.md_autotoc_md1865}
\begin{quote}
Added in Zod 3.\+23 \end{quote}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1866}{}\doxysubsubsubsection{\texorpdfstring{IP addresses}{IP addresses}}\label{README.md_autotoc_md1866}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1867}{}\doxysubsubsubsection{\texorpdfstring{IP ranges (CIDR)}{IP ranges (CIDR)}}\label{README.md_autotoc_md1867}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1868}{}\doxysubsubsection{\texorpdfstring{Numbers}{Numbers}}\label{README.md_autotoc_md1868}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1869}{}\doxysubsubsection{\texorpdfstring{Big\+Ints}{Big\+Ints}}\label{README.md_autotoc_md1869}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1870}{}\doxysubsubsection{\texorpdfstring{Na\+Ns}{Na\+Ns}}\label{README.md_autotoc_md1870}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1871}{}\doxysubsubsection{\texorpdfstring{Booleans}{Booleans}}\label{README.md_autotoc_md1871}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1872}{}\doxysubsubsection{\texorpdfstring{Dates}{Dates}}\label{README.md_autotoc_md1872}
...
For older zod versions, use \`{}z.preprocess\`{} like \href{https://github.com/colinhacks/zod/discussions/879\#discussioncomment-2036276}{\texttt{ described in this thread}}.\hypertarget{README.md_autotoc_md1873}{}\doxysubsubsection{\texorpdfstring{Zod enums}{Zod enums}}\label{README.md_autotoc_md1873}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1874}{}\doxysubsubsection{\texorpdfstring{Native enums}{Native enums}}\label{README.md_autotoc_md1874}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1875}{}\doxysubsubsection{\texorpdfstring{Optionals}{Optionals}}\label{README.md_autotoc_md1875}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1876}{}\doxysubsubsection{\texorpdfstring{Nullables}{Nullables}}\label{README.md_autotoc_md1876}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1877}{}\doxysubsubsection{\texorpdfstring{Objects}{Objects}}\label{README.md_autotoc_md1877}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1878}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .shape}}{{\ttfamily .shape}}}\label{README.md_autotoc_md1878}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1879}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .keyof}}{{\ttfamily .keyof}}}\label{README.md_autotoc_md1879}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1880}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .extend}}{{\ttfamily .extend}}}\label{README.md_autotoc_md1880}
...
You can use {\ttfamily .extend} to overwrite fields! Be careful with this power!\hypertarget{README.md_autotoc_md1881}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .merge}}{{\ttfamily .merge}}}\label{README.md_autotoc_md1881}
...
\hypertarget{README.md_autotoc_md1882}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .pick/.omit}}{{\ttfamily .pick/.omit}}}\label{README.md_autotoc_md1882}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1883}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .partial}}{{\ttfamily .partial}}}\label{README.md_autotoc_md1883}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1884}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .deep\+Partial}}{{\ttfamily .deep\+Partial}}}\label{README.md_autotoc_md1884}
...
\hypertarget{README.md_autotoc_md1885}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .required}}{{\ttfamily .required}}}\label{README.md_autotoc_md1885}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1886}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .passthrough}}{{\ttfamily .passthrough}}}\label{README.md_autotoc_md1886}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1887}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .strict}}{{\ttfamily .strict}}}\label{README.md_autotoc_md1887}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1888}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .strip}}{{\ttfamily .strip}}}\label{README.md_autotoc_md1888}
You can use the {\ttfamily .strip} method to reset an object schema to the default behavior (stripping unrecognized keys).\hypertarget{README.md_autotoc_md1889}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .catchall}}{{\ttfamily .catchall}}}\label{README.md_autotoc_md1889}
...
Using {\ttfamily .catchall()} obviates {\ttfamily .passthrough()} , {\ttfamily .strip()} , or {\ttfamily .strict()}. All keys are now considered "{}known"{}.\hypertarget{README.md_autotoc_md1890}{}\doxysubsubsection{\texorpdfstring{Arrays}{Arrays}}\label{README.md_autotoc_md1890}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1891}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .element}}{{\ttfamily .element}}}\label{README.md_autotoc_md1891}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1892}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .nonempty}}{{\ttfamily .nonempty}}}\label{README.md_autotoc_md1892}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1893}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .min/.max/.length}}{{\ttfamily .min/.max/.length}}}\label{README.md_autotoc_md1893}
...
Unlike {\ttfamily .nonempty()} these methods do not change the inferred type.\hypertarget{README.md_autotoc_md1894}{}\doxysubsubsection{\texorpdfstring{Tuples}{Tuples}}\label{README.md_autotoc_md1894}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1895}{}\doxysubsubsection{\texorpdfstring{Unions}{Unions}}\label{README.md_autotoc_md1895}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1896}{}\doxysubsubsection{\texorpdfstring{Discriminated unions}{Discriminated unions}}\label{README.md_autotoc_md1896}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1897}{}\doxysubsubsection{\texorpdfstring{Records}{Records}}\label{README.md_autotoc_md1897}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1899}{}\doxysubsubsection{\texorpdfstring{Sets}{Sets}}\label{README.md_autotoc_md1899}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1900}{}\doxysubsubsection{\texorpdfstring{Intersections}{Intersections}}\label{README.md_autotoc_md1900}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1901}{}\doxysubsubsection{\texorpdfstring{Recursive types}{Recursive types}}\label{README.md_autotoc_md1901}
...
Thanks to \href{https://github.com/crasite}{\texttt{ crasite}} for this example.\hypertarget{README.md_autotoc_md1902}{}\doxysubsubsubsection{\texorpdfstring{Zod\+Type with Zod\+Effects}{Zod\+Type with Zod\+Effects}}\label{README.md_autotoc_md1902}
...
Thanks to \href{https://github.com/marcus13371337}{\texttt{ marcus13371337}} and \href{https://github.com/JoelBeeldi}{\texttt{ Joel\+Beeldi}} for this example.\hypertarget{README.md_autotoc_md1903}{}\doxysubsubsubsection{\texorpdfstring{JSON type}{JSON type}}\label{README.md_autotoc_md1903}
...
Thanks to \href{https://github.com/ggoodman}{\texttt{ ggoodman}} for suggesting this.\hypertarget{README.md_autotoc_md1904}{}\doxysubsubsubsection{\texorpdfstring{Cyclical objects}{Cyclical objects}}\label{README.md_autotoc_md1904}
...
\hypertarget{README.md_autotoc_md1905}{}\doxysubsubsection{\texorpdfstring{Promises}{Promises}}\label{README.md_autotoc_md1905}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1906}{}\doxysubsubsection{\texorpdfstring{Instanceof}{Instanceof}}\label{README.md_autotoc_md1906}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1907}{}\doxysubsubsection{\texorpdfstring{Functions}{Functions}}\label{README.md_autotoc_md1907}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1908}{}\doxysubsubsection{\texorpdfstring{Preprocess}{Preprocess}}\label{README.md_autotoc_md1908}
\begin{quote}
...
This returns a {\ttfamily Zod\+Effects} instance. {\ttfamily Zod\+Effects} is a wrapper class that contains all logic pertaining to preprocessing, refinements, and transforms.\hypertarget{README.md_autotoc_md1909}{}\doxysubsubsection{\texorpdfstring{Custom schemas}{Custom schemas}}\label{README.md_autotoc_md1909}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1910}{}\doxysubsubsection{\texorpdfstring{Schema methods}{Schema methods}}\label{README.md_autotoc_md1910}
All Zod schemas contain certain methods.\hypertarget{README.md_autotoc_md1911}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .parse}}{{\ttfamily .parse}}}\label{README.md_autotoc_md1911}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1912}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .parse\+Async}}{{\ttfamily .parse\+Async}}}\label{README.md_autotoc_md1912}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1913}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .safe\+Parse}}{{\ttfamily .safe\+Parse}}}\label{README.md_autotoc_md1913}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1914}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .safe\+Parse\+Async}}{{\ttfamily .safe\+Parse\+Async}}}\label{README.md_autotoc_md1914}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1915}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .refine}}{{\ttfamily .refine}}}\label{README.md_autotoc_md1915}
...
\hypertarget{README.md_autotoc_md1916}{}\doxysubsubsubsubsection{\texorpdfstring{Arguments}{Arguments}}\label{README.md_autotoc_md1916}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1917}{}\doxysubsubsubsubsection{\texorpdfstring{Customize error path}{Customize error path}}\label{README.md_autotoc_md1917}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1918}{}\doxysubsubsubsubsection{\texorpdfstring{Asynchronous refinements}{Asynchronous refinements}}\label{README.md_autotoc_md1918}
...
\hypertarget{README.md_autotoc_md1919}{}\doxysubsubsubsubsection{\texorpdfstring{Relationship to transforms}{Relationship to transforms}}\label{README.md_autotoc_md1919}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1920}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .super\+Refine}}{{\ttfamily .super\+Refine}}}\label{README.md_autotoc_md1920}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1922}{}\doxysubsubsubsubsection{\texorpdfstring{Type refinements}{Type refinements}}\label{README.md_autotoc_md1922}
...
\hypertarget{README.md_autotoc_md1923}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .transform}}{{\ttfamily .transform}}}\label{README.md_autotoc_md1923}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1924}{}\doxysubsubsubsubsection{\texorpdfstring{Chaining order}{Chaining order}}\label{README.md_autotoc_md1924}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1925}{}\doxysubsubsubsubsection{\texorpdfstring{Validating during transform}{Validating during transform}}\label{README.md_autotoc_md1925}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1926}{}\doxysubsubsubsubsection{\texorpdfstring{Relationship to refinements}{Relationship to refinements}}\label{README.md_autotoc_md1926}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1927}{}\doxysubsubsubsubsection{\texorpdfstring{Async transforms}{Async transforms}}\label{README.md_autotoc_md1927}
...
\hypertarget{README.md_autotoc_md1928}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .default}}{{\ttfamily .default}}}\label{README.md_autotoc_md1928}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md1929}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .describe}}{{\ttfamily .describe}}}\label{README.md_autotoc_md1929}
...
This can be useful for documenting a field, for example in a JSON Schema using a library like \href{https://github.com/StefanTerdell/zod-to-json-schema}{\texttt{ {\ttfamily zod-\/to-\/json-\/schema}}}).\hypertarget{README.md_autotoc_md1930}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .catch}}{{\ttfamily .catch}}}\label{README.md_autotoc_md1930}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md1931}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .optional}}{{\ttfamily .optional}}}\label{README.md_autotoc_md1931}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1932}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .nullable}}{{\ttfamily .nullable}}}\label{README.md_autotoc_md1932}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1933}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .nullish}}{{\ttfamily .nullish}}}\label{README.md_autotoc_md1933}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1934}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .array}}{{\ttfamily .array}}}\label{README.md_autotoc_md1934}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1935}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .promise}}{{\ttfamily .promise}}}\label{README.md_autotoc_md1935}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1936}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .or}}{{\ttfamily .or}}}\label{README.md_autotoc_md1936}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1937}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .and}}{{\ttfamily .and}}}\label{README.md_autotoc_md1937}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1938}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .brand}}{{\ttfamily .brand}}}\label{README.md_autotoc_md1938}
...
Note that branded types do not affect the runtime result of {\ttfamily .parse}. It is a static-\/only construct.\hypertarget{README.md_autotoc_md1939}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .readonly}}{{\ttfamily .readonly}}}\label{README.md_autotoc_md1939}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1940}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily .pipe}}{{\ttfamily .pipe}}}\label{README.md_autotoc_md1940}
...
The {\ttfamily .pipe()} method returns a {\ttfamily Zod\+Pipeline} instance.\hypertarget{README.md_autotoc_md1941}{}\doxysubsubsubsubsection{\texorpdfstring{You can use {\ttfamily .pipe()} to fix common issues with {\ttfamily z.\+coerce}.}{You can use {\ttfamily .pipe()} to fix common issues with {\ttfamily z.\+coerce}.}}\label{README.md_autotoc_md1941}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1942}{}\doxysubsubsection{\texorpdfstring{Guides and concepts}{Guides and concepts}}\label{README.md_autotoc_md1942}
\hypertarget{README.md_autotoc_md1943}{}\doxysubsubsubsection{\texorpdfstring{Type inference}{Type inference}}\label{README.md_autotoc_md1943}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1944}{}\doxysubsubsubsection{\texorpdfstring{Writing generic functions}{Writing generic functions}}\label{README.md_autotoc_md1944}
...
The Result is now fully and properly typed, and the type system can infer the specific subclass of the schema.\hypertarget{README.md_autotoc_md1945}{}\doxysubsubsubsubsection{\texorpdfstring{Inferring the inferred type}{Inferring the inferred type}}\label{README.md_autotoc_md1945}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1946}{}\doxysubsubsubsubsection{\texorpdfstring{Constraining allowable inputs}{Constraining allowable inputs}}\label{README.md_autotoc_md1946}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1947}{}\doxysubsubsubsection{\texorpdfstring{Error handling}{Error handling}}\label{README.md_autotoc_md1947}
...
Zod\textquotesingle{}s error reporting emphasizes {\itshape completeness} and {\itshape correctness}. If you are looking to present a useful error message to the end user, you should either override Zod\textquotesingle{}s error messages using an error map (described in detail in the Error Handling guide) or use a third-\/party library like \href{https://github.com/causaly/zod-validation-error}{\texttt{ {\ttfamily zod-\/validation-\/error}}}\hypertarget{README.md_autotoc_md1948}{}\doxysubsubsubsection{\texorpdfstring{Error formatting}{Error formatting}}\label{README.md_autotoc_md1948}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1949}{}\doxysubsubsection{\texorpdfstring{Comparison}{Comparison}}\label{README.md_autotoc_md1949}
There are a handful of other widely-\/used validation libraries, but all of them have certain design limitations that make for a non-\/ideal developer experience.\hypertarget{README.md_autotoc_md1950}{}\doxysubsubsubsection{\texorpdfstring{Joi}{Joi}}\label{README.md_autotoc_md1950}
\href{https://github.com/hapijs/joi}{\texttt{ https\+://github.\+com/hapijs/joi}}

Doesn\textquotesingle{}t support static type inference 😕\hypertarget{README.md_autotoc_md1951}{}\doxysubsubsubsection{\texorpdfstring{Yup}{Yup}}\label{README.md_autotoc_md1951}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1952}{}\doxysubsubsubsection{\texorpdfstring{io-\/ts}{io-\/ts}}\label{README.md_autotoc_md1952}
...
\item Missing promise schemas
\item Missing function schemas
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1953}{}\doxysubsubsubsection{\texorpdfstring{Runtypes}{Runtypes}}\label{README.md_autotoc_md1953}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1954}{}\doxysubsubsubsection{\texorpdfstring{Ow}{Ow}}\label{README.md_autotoc_md1954}
...
If you want to validate function inputs, use function schemas in Zod! It\textquotesingle{}s a much simpler approach that lets you reuse a function type declaration without repeating yourself (namely, copy-\/pasting a bunch of ow assertions at the beginning of every function). Also Zod lets you validate your return types as well, so you can be sure there won\textquotesingle{}t be any unexpected data passed downstream.\hypertarget{README.md_autotoc_md1955}{}\doxysubsubsection{\texorpdfstring{Changelog}{Changelog}}\label{README.md_autotoc_md1955}
