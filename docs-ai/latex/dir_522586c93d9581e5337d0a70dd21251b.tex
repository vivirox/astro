\doxysection{node\+\_\+modules/rehype-\/raw/node\+\_\+modules/hast-\/util-\/raw Directory Reference}
\hypertarget{dir_522586c93d9581e5337d0a70dd21251b}{}\label{dir_522586c93d9581e5337d0a70dd21251b}\index{node\_modules/rehype-\/raw/node\_modules/hast-\/util-\/raw Directory Reference@{node\_modules/rehype-\/raw/node\_modules/hast-\/util-\/raw Directory Reference}}
...
\href{https://github.com/syntax-tree/hast}{\texttt{ hast}} utility to parse the tree and semistandard {\ttfamily raw} nodes (strings of HTML) again, keeping positional info okay.\hypertarget{readme.md_autotoc_md28856}{}\doxysubsection{\texorpdfstring{Contents}{Contents}}\label{readme.md_autotoc_md28856}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md28857}{}\doxysubsection{\texorpdfstring{What is this?}{What is this?}}\label{readme.md_autotoc_md28857}
This package is a utility to parse a document again. It passes each node and embedded raw HTML through an HTML parser (\href{https://github.com/inikulin/parse5}{\texttt{ {\ttfamily parse5}}}), to recreate a tree exactly as how a browser would parse it, while keeping the original data and positional info intact.\hypertarget{readme.md_autotoc_md28858}{}\doxysubsection{\texorpdfstring{When should I use this?}{When should I use this?}}\label{readme.md_autotoc_md28858}
...
The plugin \href{https://github.com/rehypejs/rehype-raw}{\texttt{ {\ttfamily rehype-\/raw}}} wraps this utility at a higher-\/level (easier) abstraction.\hypertarget{readme.md_autotoc_md28859}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{readme.md_autotoc_md28859}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md28860}{}\doxysubsection{\texorpdfstring{Use}{Use}}\label{readme.md_autotoc_md28860}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md28861}{}\doxysubsection{\texorpdfstring{API}{API}}\label{readme.md_autotoc_md28861}
\hypertarget{readme.md_autotoc_md28862}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Options}}{{\ttfamily Options}}}\label{readme.md_autotoc_md28862}
Configuration.\hypertarget{readme.md_autotoc_md28863}{}\doxysubsubsubsubsubsection{\texorpdfstring{Fields}{Fields}}\label{readme.md_autotoc_md28863}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md28864}{}\doxysubsubsection{\texorpdfstring{{\ttfamily raw(tree, options)}}{{\ttfamily raw(tree, options)}}}\label{readme.md_autotoc_md28864}
Pass a hast tree through an HTML parser, which will fix nesting, and turn raw nodes into actual nodes.\hypertarget{readme.md_autotoc_md28865}{}\doxysubsubsubsubsubsection{\texorpdfstring{Parameters}{Parameters}}\label{readme.md_autotoc_md28865}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md28866}{}\doxysubsubsubsubsubsection{\texorpdfstring{Returns}{Returns}}\label{readme.md_autotoc_md28866}
Parsed again tree ({\ttfamily Root \texorpdfstring{$\vert$}{|} Root\+Content}).\hypertarget{readme.md_autotoc_md28867}{}\doxysubsection{\texorpdfstring{Types}{Types}}\label{readme.md_autotoc_md28867}
...
The {\ttfamily Raw} node type is registered by and exposed from \href{https://github.com/syntax-tree/mdast-util-to-hast}{\texttt{ {\ttfamily mdast-\/util-\/to-\/hast}}}.\hypertarget{readme.md_autotoc_md28868}{}\doxysubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{readme.md_autotoc_md28868}
Projects maintained by the unified collective are compatible with maintained versions of Node.\+js.

When we cut a new major release, we drop support for unmaintained versions of Node. This means we try to keep the current release line, {\ttfamily hast-\/util-\/raw@\texorpdfstring{$^\wedge$}{\string^}9}, compatible with Node.\+js 16.\hypertarget{readme.md_autotoc_md28869}{}\doxysubsection{\texorpdfstring{Security}{Security}}\label{readme.md_autotoc_md28869}
...
Either do not use this utility in combination with user input, or use \href{https://github.com/syntax-tree/hast-util-sanitize}{\texttt{ {\ttfamily hast-\/util-\/santize}}}.\hypertarget{readme.md_autotoc_md28870}{}\doxysubsection{\texorpdfstring{Related}{Related}}\label{readme.md_autotoc_md28870}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md28871}{}\doxysubsection{\texorpdfstring{Contribute}{Contribute}}\label{readme.md_autotoc_md28871}
...
This project has a \href{https://github.com/syntax-tree/.github/blob/main/code-of-conduct.md}{\texttt{ code of conduct}}. By interacting with this repository, organization, or community you agree to abide by its terms.\hypertarget{readme.md_autotoc_md28872}{}\doxysubsection{\texorpdfstring{License}{License}}\label{readme.md_autotoc_md28872}
