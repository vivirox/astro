\doxysection{node\+\_\+modules/node-\/fetch Directory Reference}
\hypertarget{dir_eea7b0df960e425fc2453ada46ede069}{}\label{dir_eea7b0df960e425fc2453ada46ede069}\index{node\_modules/node-\/fetch Directory Reference@{node\_modules/node-\/fetch Directory Reference}}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24587}{}\doxysubsection{\texorpdfstring{Motivation}{Motivation}}\label{README.md_autotoc_md24587}
...
See Matt Andrews\textquotesingle{} \href{https://github.com/matthew-andrews/isomorphic-fetch}{\texttt{ isomorphic-\/fetch}} or Leonardo Quixada\textquotesingle{}s \href{https://github.com/lquixada/cross-fetch}{\texttt{ cross-\/fetch}} for isomorphic usage (exports {\ttfamily node-\/fetch} for server-\/side, {\ttfamily whatwg-\/fetch} for client-\/side).\hypertarget{README.md_autotoc_md24588}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md24588}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24589}{}\doxysubsection{\texorpdfstring{Difference from client-\/side fetch}{Difference from client-\/side fetch}}\label{README.md_autotoc_md24589}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24590}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md24590}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24591}{}\doxysubsection{\texorpdfstring{Loading and configuring the module}{Loading and configuring the module}}\label{README.md_autotoc_md24591}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24592}{}\doxysubsection{\texorpdfstring{Common Usage}{Common Usage}}\label{README.md_autotoc_md24592}
NOTE\+: The documentation below is up-\/to-\/date with {\ttfamily 2.\+x} releases; see the \href{https://github.com/bitinn/node-fetch/blob/1.x/README.md}{\texttt{ {\ttfamily 1.\+x} readme}}, \href{https://github.com/bitinn/node-fetch/blob/1.x/CHANGELOG.md}{\texttt{ changelog}} and 2.x upgrade guide for the differences.\hypertarget{README.md_autotoc_md24593}{}\doxysubsubsubsection{\texorpdfstring{Plain text or HTML}{Plain text or HTML}}\label{README.md_autotoc_md24593}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24594}{}\doxysubsubsubsection{\texorpdfstring{JSON}{JSON}}\label{README.md_autotoc_md24594}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24595}{}\doxysubsubsubsection{\texorpdfstring{Simple Post}{Simple Post}}\label{README.md_autotoc_md24595}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24596}{}\doxysubsubsubsection{\texorpdfstring{Post with JSON}{Post with JSON}}\label{README.md_autotoc_md24596}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24597}{}\doxysubsubsubsection{\texorpdfstring{Post with form parameters}{Post with form parameters}}\label{README.md_autotoc_md24597}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24598}{}\doxysubsubsubsection{\texorpdfstring{Handling exceptions}{Handling exceptions}}\label{README.md_autotoc_md24598}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24599}{}\doxysubsubsubsection{\texorpdfstring{Handling client and server errors}{Handling client and server errors}}\label{README.md_autotoc_md24599}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24600}{}\doxysubsection{\texorpdfstring{Advanced Usage}{Advanced Usage}}\label{README.md_autotoc_md24600}
\hypertarget{README.md_autotoc_md24601}{}\doxysubsubsubsection{\texorpdfstring{Streams}{Streams}}\label{README.md_autotoc_md24601}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24602}{}\doxysubsubsubsection{\texorpdfstring{Buffer}{Buffer}}\label{README.md_autotoc_md24602}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24603}{}\doxysubsubsubsection{\texorpdfstring{Accessing Headers and other Meta data}{Accessing Headers and other Meta data}}\label{README.md_autotoc_md24603}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24604}{}\doxysubsubsubsection{\texorpdfstring{Extract Set-\/\+Cookie Header}{Extract Set-\/\+Cookie Header}}\label{README.md_autotoc_md24604}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24605}{}\doxysubsubsubsection{\texorpdfstring{Post data using a file stream}{Post data using a file stream}}\label{README.md_autotoc_md24605}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24606}{}\doxysubsubsubsection{\texorpdfstring{Post with form-\/data (detect multipart)}{Post with form-\/data (detect multipart)}}\label{README.md_autotoc_md24606}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24607}{}\doxysubsubsubsection{\texorpdfstring{Request cancellation with Abort\+Signal}{Request cancellation with Abort\+Signal}}\label{README.md_autotoc_md24607}
\begin{quote}
...
See \href{https://github.com/bitinn/node-fetch/blob/master/test/test.js}{\texttt{ test cases}} for more examples.\hypertarget{README.md_autotoc_md24608}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md24608}
\hypertarget{README.md_autotoc_md24609}{}\doxysubsubsection{\texorpdfstring{fetch(url\mbox{[}, options\mbox{]})}{fetch(url\mbox{[}, options\mbox{]})}}\label{README.md_autotoc_md24609}
...
\Hypertarget{README.md_fetch-options}%
 \hypertarget{README.md_autotoc_md24610}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md24610}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24611}{}\doxysubsubsubsubsection{\texorpdfstring{Default Headers}{Default Headers}}\label{README.md_autotoc_md24611}
...
Note\+: when {\ttfamily body} is a {\ttfamily Stream}, {\ttfamily Content-\/\+Length} is not set automatically.\hypertarget{README.md_autotoc_md24612}{}\doxysubsubsubsubsection{\texorpdfstring{Custom Agent}{Custom Agent}}\label{README.md_autotoc_md24612}
...
\Hypertarget{README.md_class-request}%
 \hypertarget{README.md_autotoc_md24613}{}\doxysubsubsection{\texorpdfstring{Class\+: Request}{Class\+: Request}}\label{README.md_autotoc_md24613}
...
See \doxylink{README.md_fetch-options}{options} for exact meaning of these extensions.\hypertarget{README.md_autotoc_md24614}{}\doxysubsubsubsection{\texorpdfstring{new Request(input\mbox{[}, options\mbox{]})}{new Request(input\mbox{[}, options\mbox{]})}}\label{README.md_autotoc_md24614}
...
\Hypertarget{README.md_class-response}%
 \hypertarget{README.md_autotoc_md24615}{}\doxysubsubsection{\texorpdfstring{Class\+: Response}{Class\+: Response}}\label{README.md_autotoc_md24615}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24616}{}\doxysubsubsubsection{\texorpdfstring{new Response(\mbox{[}body\mbox{[}, options\mbox{]}\mbox{]})}{new Response(\mbox{[}body\mbox{[}, options\mbox{]}\mbox{]})}}\label{README.md_autotoc_md24616}
...
Because Node.\+js does not implement service workers (for which this class was designed), one rarely has to construct a {\ttfamily Response} directly.\hypertarget{README.md_autotoc_md24617}{}\doxysubsubsubsection{\texorpdfstring{response.\+ok}{response.\+ok}}\label{README.md_autotoc_md24617}

\footnotesize {\itshape (spec-\/compliant)}
\normalsize 

Convenience property representing if the request ended normally. Will evaluate to true if the response status was greater than or equal to 200 but smaller than 300.\hypertarget{README.md_autotoc_md24618}{}\doxysubsubsubsection{\texorpdfstring{response.\+redirected}{response.\+redirected}}\label{README.md_autotoc_md24618}
...
\Hypertarget{README.md_class-headers}%
 \hypertarget{README.md_autotoc_md24619}{}\doxysubsubsection{\texorpdfstring{Class\+: Headers}{Class\+: Headers}}\label{README.md_autotoc_md24619}
This class allows manipulating and iterating over a set of HTTP headers. All methods specified in the \href{https://fetch.spec.whatwg.org/}{\texttt{ Fetch Standard}} are implemented.\hypertarget{README.md_autotoc_md24620}{}\doxysubsubsubsection{\texorpdfstring{new Headers(\mbox{[}init\mbox{]})}{new Headers(\mbox{[}init\mbox{]})}}\label{README.md_autotoc_md24620}
...
\Hypertarget{README.md_iface-body}%
 \hypertarget{README.md_autotoc_md24621}{}\doxysubsubsection{\texorpdfstring{Interface\+: Body}{Interface\+: Body}}\label{README.md_autotoc_md24621}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md24622}{}\doxysubsubsubsection{\texorpdfstring{body.\+body}{body.\+body}}\label{README.md_autotoc_md24622}
...
Data are encapsulated in the {\ttfamily Body} object. Note that while the \href{https://fetch.spec.whatwg.org/}{\texttt{ Fetch Standard}} requires the property to always be a WHATWG {\ttfamily Readable\+Stream}, in node-\/fetch it is a Node.\+js \href{https://nodejs.org/api/stream.html\#stream_readable_streams}{\texttt{ {\ttfamily Readable} stream}}.\hypertarget{README.md_autotoc_md24623}{}\doxysubsubsubsection{\texorpdfstring{body.\+body\+Used}{body.\+body\+Used}}\label{README.md_autotoc_md24623}
...
A boolean property for if this body has been consumed. Per the specs, a consumed body cannot be used again.\hypertarget{README.md_autotoc_md24624}{}\doxysubsubsubsection{\texorpdfstring{body.\+array\+Buffer()}{body.\+array\+Buffer()}}\label{README.md_autotoc_md24624}
\hypertarget{README.md_autotoc_md24625}{}\doxysubsubsubsection{\texorpdfstring{body.\+blob()}{body.\+blob()}}\label{README.md_autotoc_md24625}
\hypertarget{README.md_autotoc_md24626}{}\doxysubsubsubsection{\texorpdfstring{body.\+json()}{body.\+json()}}\label{README.md_autotoc_md24626}
\hypertarget{README.md_autotoc_md24627}{}\doxysubsubsubsection{\texorpdfstring{body.\+text()}{body.\+text()}}\label{README.md_autotoc_md24627}
...
Consume the body and return a promise that will resolve to one of these formats.\hypertarget{README.md_autotoc_md24628}{}\doxysubsubsubsection{\texorpdfstring{body.\+buffer()}{body.\+buffer()}}\label{README.md_autotoc_md24628}
...
Consume the body and return a promise that will resolve to a Buffer.\hypertarget{README.md_autotoc_md24629}{}\doxysubsubsubsection{\texorpdfstring{body.\+text\+Converted()}{body.\+text\+Converted()}}\label{README.md_autotoc_md24629}
...
\Hypertarget{README.md_class-fetcherror}%
 \hypertarget{README.md_autotoc_md24630}{}\doxysubsubsection{\texorpdfstring{Class\+: Fetch\+Error}{Class\+: Fetch\+Error}}\label{README.md_autotoc_md24630}
...
\Hypertarget{README.md_class-aborterror}%
 \hypertarget{README.md_autotoc_md24631}{}\doxysubsubsection{\texorpdfstring{Class\+: Abort\+Error}{Class\+: Abort\+Error}}\label{README.md_autotoc_md24631}

\footnotesize {\itshape (node-\/fetch extension)}
\normalsize 

An Error thrown when the request is aborted in response to an {\ttfamily Abort\+Signal}\textquotesingle{}s {\ttfamily abort} event. It has a {\ttfamily name} property of {\ttfamily Abort\+Error}. See \href{https://github.com/bitinn/node-fetch/blob/master/ERROR-HANDLING.md}{\texttt{ ERROR-\/\+HANDLING.\+MD}} for more info.\hypertarget{README.md_autotoc_md24632}{}\doxysubsection{\texorpdfstring{Acknowledgement}{Acknowledgement}}\label{README.md_autotoc_md24632}
Thanks to \href{https://github.com/github/fetch}{\texttt{ github/fetch}} for providing a solid implementation reference.

{\ttfamily node-\/fetch} v1 was maintained by \href{https://github.com/bitinn}{\texttt{ @bitinn}}; v2 was maintained by \href{https://github.com/timothygu}{\texttt{ @\+Timothy\+Gu}}, \href{https://github.com/bitinn}{\texttt{ @bitinn}} and \href{https://github.com/jimmywarting}{\texttt{ @jimmywarting}}; v2 readme is written by \href{https://github.com/jkantr}{\texttt{ @jkantr}}.\hypertarget{README.md_autotoc_md24633}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md24633}
MIT 