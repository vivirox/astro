...
\label{md_node__modules_2mkdirp_2readme_autotoc_md24194}%
\Hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24194}%
...
\normalsize \hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24195}{}\doxysection{\texorpdfstring{example}{example}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24195}
\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24196}{}\doxysubsection{\texorpdfstring{pow.\+js}{pow.\+js}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24196}

\begin{DoxyCode}{0}
\DoxyCodeLine{//\ hybrid\ module,\ import\ or\ require()\ both\ work}
\DoxyCodeLine{import\ \{\ mkdirp\ \}\ from\ 'mkdirp'}
\DoxyCodeLine{//\ or:}
...
And now /tmp/foo/bar/baz exists, huzzah!\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24197}{}\doxysection{\texorpdfstring{methods}{methods}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24197}

\begin{DoxyCode}{0}
\DoxyCodeLine{import\ \{\ mkdirp\ \}\ from\ 'mkdirp'}

\end{DoxyCode}
\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24198}{}\doxysubsection{\texorpdfstring{{\ttfamily mkdirp(dir\+: string, opts?\+: Mkdirp\+Options) =\texorpdfstring{$>$}{>} Promise\texorpdfstring{$<$}{<}string \texorpdfstring{$\vert$}{|} undefined\texorpdfstring{$>$}{>}}}{{\ttfamily mkdirp(dir\+: string, opts?\+: Mkdirp\+Options) =\texorpdfstring{$>$}{>} Promise\texorpdfstring{$<$}{<}string \texorpdfstring{$\vert$}{|} undefined\texorpdfstring{$>$}{>}}}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24198}
...
If {\ttfamily opts.\+mode} isn\textquotesingle{}t specified, it defaults to {\ttfamily 0o777}.
...
You can also override just one or the other of {\ttfamily mkdir} and {\ttfamily stat} by passing in {\ttfamily opts.\+stat} or {\ttfamily opts.\+mkdir}, or providing an {\ttfamily fs} option that only overrides one of these.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24199}{}\doxysubsection{\texorpdfstring{{\ttfamily mkdirp.\+sync(dir\+: string, opts\+: Mkdirp\+Options) =\texorpdfstring{$>$}{>} string\texorpdfstring{$\vert$}{|}undefined}}{{\ttfamily mkdirp.\+sync(dir\+: string, opts\+: Mkdirp\+Options) =\texorpdfstring{$>$}{>} string\texorpdfstring{$\vert$}{|}undefined}}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24199}
...
You can also override just one or the other of {\ttfamily mkdir\+Sync} and {\ttfamily stat\+Sync} by passing in {\ttfamily opts.\+stat\+Sync} or {\ttfamily opts.\+mkdir\+Sync}, or providing an {\ttfamily fs} option that only overrides one of these.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24200}{}\doxysubsection{\texorpdfstring{{\ttfamily mkdirp.\+manual}, {\ttfamily mkdirp.\+manual\+Sync}}{{\ttfamily mkdirp.\+manual}, {\ttfamily mkdirp.\+manual\+Sync}}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24200}
Use the manual implementation (not the native one). This is the default when the native implementation is not available or the stat/mkdir implementation is overridden.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24201}{}\doxysubsection{\texorpdfstring{{\ttfamily mkdirp.\+native}, {\ttfamily mkdirp.\+native\+Sync}}{{\ttfamily mkdirp.\+native}, {\ttfamily mkdirp.\+native\+Sync}}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24201}
Use the native implementation (not the manual one). This is the default when the native implementation is available and stat/mkdir are not overridden.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24202}{}\doxysection{\texorpdfstring{implementation}{implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24202}
On Node.\+js v10.\+12.\+0 and above, use the native {\ttfamily fs.\+mkdir(p, \{recursive\+:true\})} option, unless {\ttfamily fs.\+mkdir}/{\ttfamily fs.\+mkdir\+Sync} has been overridden by an option.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24203}{}\doxysubsection{\texorpdfstring{native implementation}{native implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24203}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24204}{}\doxysubsection{\texorpdfstring{manual implementation}{manual implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24204}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24205}{}\doxysubsection{\texorpdfstring{windows vs unix caveat}{windows vs unix caveat}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24205}
...
In order to work around this issue, the native implementation will fall back to the manual implementation if an {\ttfamily ENOENT} error is encountered.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24207}{}\doxysection{\texorpdfstring{choosing a recursive mkdir implementation}{choosing a recursive mkdir implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24207}
There are a few to choose from! Use the one that suits your needs best \+:D\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24208}{}\doxysubsection{\texorpdfstring{use {\ttfamily fs.\+mkdir(path, \{recursive\+: true\}, cb)} if\+:}{use {\ttfamily fs.\+mkdir(path, \{recursive\+: true\}, cb)} if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24208}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24209}{}\doxysubsection{\texorpdfstring{use this module (mkdirp 1.\+x or 2.\+x) if\+:}{use this module (mkdirp 1.\+x or 2.\+x) if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24209}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24210}{}\doxysubsection{\texorpdfstring{use \href{http://npm.im/make-dir}{\texttt{ {\ttfamily make-\/dir}}} if\+:}{use \href{http://npm.im/make-dir}{\texttt{ {\ttfamily make-\/dir}}} if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24210}
...
\item You don\textquotesingle{}t need/want a CLI.
\item You need to override the {\ttfamily fs} methods in use.
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24211}{}\doxysubsection{\texorpdfstring{use mkdirp 0.\+x if\+:}{use mkdirp 0.\+x if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24211}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24212}{}\doxysection{\texorpdfstring{cli}{cli}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24212}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24213}{}\doxysection{\texorpdfstring{install}{install}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24213}
...
to run the command without installing it globally.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24214}{}\doxysection{\texorpdfstring{platform support}{platform support}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24214}
This module works on node v8, but only v10 and above are officially supported, as Node v8 reached its LTS end of life 2020-\/01-\/01, which is in the past, as of this writing.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md24215}{}\doxysection{\texorpdfstring{license}{license}}\label{md_node__modules_2mkdirp_2readme_autotoc_md24215}
MIT 