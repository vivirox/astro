...
Modern Buffer API polyfill without footguns, working on Node.\+js from 0.\+8 to current.\hypertarget{Readme.md_autotoc_md30217}{}\doxysubsection{\texorpdfstring{How to use?}{How to use?}}\label{Readme.md_autotoc_md30217}
...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{Readme.md_autotoc_md30218}{}\doxysubsection{\texorpdfstring{Do I need it?}{Do I need it?}}\label{Readme.md_autotoc_md30218}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{Readme.md_autotoc_md30219}{}\doxysubsection{\texorpdfstring{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}}\label{Readme.md_autotoc_md30219}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{Readme.md_autotoc_md30220}{}\doxysubsection{\texorpdfstring{But isn\textquotesingle{}t throwing bad?}{But isn\textquotesingle{}t throwing bad?}}\label{Readme.md_autotoc_md30220}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{Readme.md_autotoc_md30221}{}\doxysubsubsection{\texorpdfstring{Would it affect third-\/party modules?}{Would it affect third-\/party modules?}}\label{Readme.md_autotoc_md30221}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{Readme.md_autotoc_md30222}{}\doxysubsubsection{\texorpdfstring{But I don\textquotesingle{}t want throwing…}{But I don\textquotesingle{}t want throwing…}}\label{Readme.md_autotoc_md30222}
That is also fine!
...
Note that using a linter to catch accidential {\ttfamily Buffer} constructor usage in this case is strongly recommended. {\ttfamily Buffer} is not overriden in this usecase, so linters won\textquotesingle{}t get confused.\hypertarget{Readme.md_autotoc_md30223}{}\doxysubsection{\texorpdfstring{«\+Without footguns»?}{«\+Without footguns»?}}\label{Readme.md_autotoc_md30223}
