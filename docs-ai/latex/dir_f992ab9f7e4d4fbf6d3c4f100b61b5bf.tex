\doxysection{node\+\_\+modules/@babel/helper-\/compilation-\/targets/node\+\_\+modules/lru-\/cache Directory Reference}
\hypertarget{dir_f992ab9f7e4d4fbf6d3c4f100b61b5bf}{}\label{dir_f992ab9f7e4d4fbf6d3c4f100b61b5bf}\index{node\_modules/"@babel/helper-\/compilation-\/targets/node\_modules/lru-\/cache Directory Reference@{node\_modules/"@babel/helper-\/compilation-\/targets/node\_modules/lru-\/cache Directory Reference}}


\doxysubsection{Detailed Description}
A cache object that deletes the least-\/recently-\/used items.

\href{https://travis-ci.org/isaacs/node-lru-cache}{\texttt{ }} \href{https://coveralls.io/github/isaacs/node-lru-cache}{\texttt{ }}\hypertarget{README.md_autotoc_md2480}{}\doxysubsection{\texorpdfstring{Installation\+:}{Installation\+:}}\label{README.md_autotoc_md2480}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ lru-\/cache\ -\/-\/save}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md2481}{}\doxysubsection{\texorpdfstring{Usage\+:}{Usage\+:}}\label{README.md_autotoc_md2481}
...
If you try to put an oversized thing in it, then it\textquotesingle{}ll fall out right away.\hypertarget{README.md_autotoc_md2482}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md2482}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md2483}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md2483}
