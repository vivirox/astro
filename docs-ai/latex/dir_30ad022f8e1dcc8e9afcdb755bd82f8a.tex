\doxysection{node\+\_\+modules/@trunkio/launcher/node\+\_\+modules/tar/node\+\_\+modules/minipass Directory Reference}
\hypertarget{dir_30ad022f8e1dcc8e9afcdb755bd82f8a}{}\label{dir_30ad022f8e1dcc8e9afcdb755bd82f8a}\index{node\_modules/"@trunkio/launcher/node\_modules/tar/node\_modules/minipass Directory Reference@{node\_modules/"@trunkio/launcher/node\_modules/tar/node\_modules/minipass Directory Reference}}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6490}{}\doxysubsection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.\+js Streams}}\label{README.md_autotoc_md6490}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{README.md_autotoc_md6491}{}\doxysubsubsection{\texorpdfstring{Timing}{Timing}}\label{README.md_autotoc_md6491}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6492}{}\doxysubsubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception\+: Async Opt-\/\+In}}\label{README.md_autotoc_md6492}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6493}{}\doxysubsubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/\+Low Water Marks}}\label{README.md_autotoc_md6493}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{README.md_autotoc_md6494}{}\doxysubsubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or\+: Why Minipass Is So Fast)}}\label{README.md_autotoc_md6494}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{README.md_autotoc_md6495}{}\doxysubsubsection{\texorpdfstring{Immediately emit {\ttfamily end} for empty streams (when not paused)}{Immediately emit {\ttfamily end} for empty streams (when not paused)}}\label{README.md_autotoc_md6495}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{README.md_autotoc_md6496}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily end} When Asked}{Emit {\ttfamily end} When Asked}}\label{README.md_autotoc_md6496}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{README.md_autotoc_md6497}{}\doxysubsubsection{\texorpdfstring{Emit {\ttfamily error} When Asked}{Emit {\ttfamily error} When Asked}}\label{README.md_autotoc_md6497}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{README.md_autotoc_md6498}{}\doxysubsubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "{}immediate flow"{} on Tee-\/streams}}\label{README.md_autotoc_md6498}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{README.md_autotoc_md6499}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md6499}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6500}{}\doxysubsubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{README.md_autotoc_md6500}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6501}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md6501}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{README.md_autotoc_md6502}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{README.md_autotoc_md6502}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6503}{}\doxysubsubsection{\texorpdfstring{Properties}{Properties}}\label{README.md_autotoc_md6503}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6504}{}\doxysubsubsection{\texorpdfstring{Events}{Events}}\label{README.md_autotoc_md6504}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6505}{}\doxysubsubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{README.md_autotoc_md6505}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md6506}{}\doxysubsection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{README.md_autotoc_md6506}
Here are some examples of things you can do with Minipass streams.\hypertarget{README.md_autotoc_md6507}{}\doxysubsubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "{}are you done yet"{} promise}}\label{README.md_autotoc_md6507}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6508}{}\doxysubsubsection{\texorpdfstring{collecting}{collecting}}\label{README.md_autotoc_md6508}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6509}{}\doxysubsubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{README.md_autotoc_md6509}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6510}{}\doxysubsubsection{\texorpdfstring{iteration}{iteration}}\label{README.md_autotoc_md6510}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6511}{}\doxysubsubsection{\texorpdfstring{subclass that {\ttfamily console.\+log()}s everything written into it}{subclass that {\ttfamily console.\+log()}s everything written into it}}\label{README.md_autotoc_md6511}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6512}{}\doxysubsubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{README.md_autotoc_md6512}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6513}{}\doxysubsubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}}\label{README.md_autotoc_md6513}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6514}{}\doxysubsubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-\/delimited JSON}}\label{README.md_autotoc_md6514}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6515}{}\doxysubsubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-\/delimited JSON}}\label{README.md_autotoc_md6515}
