...
{\ttfamily parameters} is also a getter, but the contents of the {\ttfamily MIMEType\+Parameters} object are mutable, as described below.\hypertarget{README.md_autotoc_md35520}{}\doxysubsubsection{\texorpdfstring{Methods}{Methods}}\label{README.md_autotoc_md35520}
...
{\itshape Note\+: the {\ttfamily is\+HTML()}, {\ttfamily is\+XML()}, and {\ttfamily is\+Java\+Script()} methods are speculative, and may be removed or changed in future major versions. See \href{https://github.com/whatwg/mimesniff/issues/48}{\texttt{ whatwg/mimesniff\#48}} for brainstorming in this area. Currently we implement these mainly because they are useful in jsdom.}\hypertarget{README.md_autotoc_md35521}{}\doxysubsection{\texorpdfstring{{\ttfamily MIMEType\+Parameters} API}{{\ttfamily MIMEType\+Parameters} API}}\label{README.md_autotoc_md35521}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md35522}{}\doxysubsection{\texorpdfstring{Raw parsing/serialization APIs}{Raw parsing/serialization APIs}}\label{README.md_autotoc_md35522}
