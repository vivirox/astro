...
description: Documentation for the real-time WebSocket communication system
---
...
The WebSocket system provides real-time communication capabilities for the therapy chat, notifications, and analytics features. It supports secure message transmission with Fully Homomorphic Encryption (FHE) and includes robust error handling and reconnection logic.
