...
test.describe('Cross-browser compatibility', () => {
  for (const [pageName, url] of Object.entries(TEST_URLS)) {
    test(`${pageName} page should work in all browsers`, async ({ page, browserName }) => {
  ...
  test('responsive navigation works correctly in all browsers', async ({ page, browserName }) => {
    // Go to home page
    await page.goto('/');
  ...
  test('animations and transitions work correctly across browsers', async ({ page, browserName }) => {
