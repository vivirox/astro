...
export const generateConsentForm = (): {
  ...
  return {
    consentText: 'I understand that this simulation does not record or store any audio, video, or conversation data. I consent to anonymous, aggregated metrics being collected to improve the system.',
    privacyPoints: [
...
export function generateConsentForm() {
  return {
    consentText: "I understand that anonymous metrics about my practice sessions may be stored locally in my browser. These metrics contain no personal information, session content, or identifiable data. They are used solely to show my progress over time.",
    privacyPoints: [
