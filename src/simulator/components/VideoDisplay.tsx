...
const VideoDisplay: React.FC<VideoDisplayProps> = ({
  ...
  return (
    <div className={`video-display relative rounded-lg overflow-hidden bg-gray-800 ${className}`} style={{ aspectRatio: '16/9' }}>
      ...
      {!isConnected && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-800 text-white">
          ...
          <p className="text-lg font-medium text-gray-300">Practice Simulation</p>
          <p className="text-sm text-gray-400 mt-1">Click Start to begin a therapeutic interaction</p>
        </div>
      )}
