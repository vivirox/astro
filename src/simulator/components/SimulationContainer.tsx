      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <p className="text-red-700 mb-4">
            Your browser doesn't support some features needed for the
            therapeutic simulator:
          </p>
          ...
          <div className="h-full flex items-center justify-center">
            <div className="text-center text-gray-500">
              ...
              <p className="text-sm mt-1">
                Read the scenario information above and prepare your response.
              </p>
              <p className="text-xs mt-4 text-blue-500">
                <span className="font-medium">Keyboard shortcuts:</span>{' '}
                <kbd className="bg-gray-100 px-1 rounded">Ctrl+Enter</kbd> to
                send, <kbd className="bg-gray-100 px-1 rounded">Ctrl+Space</kbd>{' '}
                for voice input
              </p>
            </div>
          </div>
      ...
      >
        <div className="relative">
          <textarea
            ...
            placeholder={
              isListening
                ? 'Speak now... Voice recognition active'
